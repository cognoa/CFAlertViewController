...
public class CFAlertActionUniqueSelectionTableViewCell: UITableViewCell {
    ...
    public override func awakeFromNib() {
        ...
        selectionImageView.image = UIImage(named: "CognoaAlert-unique-selection-deselected", in: bundle, compatibleWith: nil)
    }
    ...
    func configureViews() {
        ...
        if selectionItem.isSelected {
            ...
            selectionImageView.image = UIImage(named: "CognoaAlert-unique-selection-selected", in: bundle, compatibleWith: nil)
